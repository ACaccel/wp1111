...
const MineSweeper = () => {
    ...
    const switchPage = () => {
        if(startGame)
            ...
            return (<HomePage startGameOnClick={startGameOnClick} 
    ...
    return (
        <div className='mineSweeper'>
            {/* Basic TODO: `HomePage` and `Board` will switch based on the mode of
             `startGame`. If `startGame` is true, show `Board`; else show `HomePage` */}
